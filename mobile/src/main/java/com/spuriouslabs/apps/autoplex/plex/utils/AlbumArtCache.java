...
public final class AlbumArtCache {
    ...
    public static AlbumArtCache get_instance() {
        return sInstance;
    }
    ...
    public void fetch(final String artUrl, final Map<String, String> headers, final FetchListener listener) {
        ...
        new AsyncTask<Void, Void, Bitmap[]>() {
            ...
            protected Bitmap[] doInBackground(Void[] objects) {
                Bitmap[] bitmaps;
                try {
                    Bitmap bitmap = BitmapHelper.fetchAndRescaleBitmap(artUrl, headers,
    ...
    public static abstract class FetchListener {
        ...
        public void onError(String artUrl, Exception e) {
            Log.e(TAG, "AlbumArtFetchListener: error while downloading " + artUrl + " Exception: " + e.toString());
        }
    }
}
